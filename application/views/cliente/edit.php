<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('cliente/edit/'.$cliente['rut']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="comuna" value="<?php echo ($this->input->post('comuna') ? $this->input->post('comuna') : $cliente['comuna']); ?>" class="form-control" id="comuna" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="ciudad" class="control-label">Ciudad</label>
						<div class="form-group">
							<input type="text" name="ciudad" value="<?php echo ($this->input->post('ciudad') ? $this->input->post('ciudad') : $cliente['ciudad']); ?>" class="form-control" id="ciudad" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="correo" class="control-label">Correo</label>
						<div class="form-group">
							<input type="text" name="correo" value="<?php echo ($this->input->post('correo') ? $this->input->post('correo') : $cliente['correo']); ?>" class="form-control" id="correo" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="creado_en" value="<?php echo ($this->input->post('creado_en') ? $this->input->post('creado_en') : $cliente['creado_en']); ?>" class="form-control" id="creado_en" />
						</div>
					</div>
				</div>
			</div>
