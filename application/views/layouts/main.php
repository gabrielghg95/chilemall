                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="<?php echo site_url('images/icon/avatar5.png'); ?>" class="img-circle" alt="User Image">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        ...
                        <ul class="treeview-menu">
                            <li class="active">
                                <a href="<?php echo site_url('administrador/add'); ?>"><i class="fa fa-plus"></i>Agregar</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('administrador/index'); ?>"><i class="fa fa-list-ul"></i> Listar</a>
                            </li>
                        </ul>
                        </li>
                        <li>
                            ...
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('categoria/add'); ?>"><i class="fa fa-plus"></i>Agregar</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('categoria/index'); ?>"><i class="fa fa-list-ul"></i> Listar</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('cliente/add'); ?>"><i class="fa fa-plus"></i>Agregar</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Local</span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('local/add'); ?>"><i class="fa fa-plus"></i>Agregar</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Marca</span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="active">
                                ...
                                <li>
                                    <a href="<?php echo site_url('marca/index'); ?>"><i class="fa fa-list-ul"></i> Listar</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Orden</span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('orden/add'); ?>"><i class="fa fa-plus"></i>Agregar</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('orden/index'); ?>"><i class="fa fa-list-ul"></i> Listar</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li>
                                    <a href="<?php echo site_url('producto/index'); ?>"><i class="fa fa-list-ul"></i> Listar</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('sucursal/add'); ?>"><i class="fa fa-plus"></i>Agregar</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('sucursal/index'); ?>"><i class="fa fa-list-ul"></i> Listar</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('telefono/add'); ?>"><i class="fa fa-plus"></i>Agregar</a>
                                </li>
                                <li>
