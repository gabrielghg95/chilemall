<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('orden/edit/'.$orden['id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="producto_fk" class="form-control">
								...
								{
									$selected = ($producto['id'] == $orden['producto_fk']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="cliente_fk" class="form-control">
								...
								{
									$selected = ($cliente['rut'] == $orden['cliente_fk']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="cantidad" value="<?php echo ($this->input->post('cantidad') ? $this->input->post('cantidad') : $orden['cantidad']); ?>" class="form-control" id="cantidad" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="precio" class="control-label">Precio</label>
						<div class="form-group">
							<input type="text" name="precio" value="<?php echo ($this->input->post('precio') ? $this->input->post('precio') : $orden['precio']); ?>" class="form-control" id="precio" />
						</div>
					</div>
				</div>
			</div>
